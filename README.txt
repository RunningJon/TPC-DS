...
########################################################################################
By default, the installation will create the scripts in /ivanievlev/TPC-DS on the 
...
Segement's PGDATA/ivanievlev directory.  If there isn't enough space in this directory
...
- Files for the benchmark will be created in a sub-directory named ivanievlev located 
